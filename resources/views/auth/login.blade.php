...
<body>
    <div class="wrapper w-screen h-screen justify-center items-center flex flex-col bg-[#deeceb]">
        ...
        <form action="{{ route('login-process') }}" method="post">
            @csrf
            <div class="login w-80 h-[28rem] py-6 px-6 text-white relative shadow-2xl">
                <div class="z-10 flex justify-center relative flex-col w-full h-full fs-poppins">
                    <p class="text-3xl fs-poppins mb-4">Login Dulu, Yuk!</p>
                    ...
                    <p class="text-base mb-2">Belum punya akun? <a href="{{ route('register-form') }}"
                            class="underline text-blue-600 hover:text-blue-700">Registrasi</a></p>
                    <button type="submit"
                        class="text-white bg-[#6d9fa3] hover:bg-[#0d524d] focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 duration-100">Login</button>
                </div>
            </div>
        </form>
    </div>
